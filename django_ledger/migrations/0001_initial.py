    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=10, validators=[django_ledger.models.accounts.account_code_validator], verbose_name='Account Code')),
                ...
                ('coa_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ledger.chartofaccountmodel', verbose_name='Chart of Accounts')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, django_ledger.io.io_core.IOMixIn, django_ledger.models.mixins.LoggingMixIn, django_ledger.models.entity.EntityModelFiscalPeriodMixIn, django_ledger.models.entity.EntityModelClosingEntryMixIn),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('checking', 'Checking'), ('savings', 'Savings'), ('credit_card', 'Credit Card'), ('mortgage', 'Mortgage')], default='checking', max_length=20, verbose_name='Account Type')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cash_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='None_cash_account', to='django_ledger.accountmodel', verbose_name='Cash Account')),
                ('prepaid_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='None_prepaid_account', to='django_ledger.accountmodel', verbose_name='Prepaid Account')),
                ('unearned_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='None_unearned_account', to='django_ledger.accountmodel', verbose_name='Unearned Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ce_model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='django_ledger.estimatemodel', verbose_name='Associated Customer Job/Estimate')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='django_ledger.customermodel', verbose_name='Customer')),
                ('prepaid_account', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='invoice_prepaid_account', to='django_ledger.accountmodel', verbose_name='Prepaid Account')),
                ('unearned_account', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='invoice_unearned_account', to='django_ledger.accountmodel', verbose_name='Unearned Account')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='django_ledger.entityunitmodel', verbose_name='Associated Entity Unit')),
                ('ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='journal_entries', to='django_ledger.ledgermodel', verbose_name='Ledger')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='django_ledger.bankaccountmodel', verbose_name='Associated Bank Account Model')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('po_items', models.ManyToManyField(through='django_ledger.ItemTransactionModel', through_fields=('po_model', 'item_model'), to='django_ledger.itemmodel', verbose_name='Purchase Order Items')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal_entry', models.ForeignKey(editable=False, help_text='Journal Entry to be associated with this transaction.', on_delete=django.db.models.deletion.CASCADE, to='django_ledger.journalentrymodel', verbose_name='Journal Entry')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='stagedtransactionmodel',
            index=models.Index(fields=['date_posted'], name='django_ledg_date_po_cbcc8c_idx'),
        ),
        migrations.AddIndex(
            model_name='stagedtransactionmodel',
            index=models.Index(fields=['account_model'], name='django_ledg_account_53aea9_idx'),
        ),
        migrations.AddIndex(
            model_name='stagedtransactionmodel',
            index=models.Index(fields=['transaction_model'], name='django_ledg_transac_51a6b9_idx'),
        ),
        migrations.AddIndex(
