...
class BillModelAbstract(
    ...
    def is_past_due(self) -> bool:
        ...
        """
        if self.due_date:  # Pastikan due_date tidak None
    ...
    def mark_as_paid(self,
        ...
        #if self.date_paid and self.date_paid > get_localdate():
        #    raise BillModelValidationError(f'Cannot pay {self.__class__.__name__} in the future.')

        #if self.date_paid and self.date_approved and self.date_paid.date() < self.date_approved.date():
        #    raise BillModelValidationError(
